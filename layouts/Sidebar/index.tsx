...
import { SIDEBAR_ITEMS, SIDEBAR_ITEMS_TEACHER, SIDEBAR_ITEMS_STUDENT } from './Sidebar.config';
...
const Sidebar: React.FC<Props> = ({ className = '', style, ...props }) => {
	...
	const sidebarItems = useMemo(() => {
		if(router.pathname.includes('stud'))
			return SIDEBAR_ITEMS_STUDENT;
		else if(router.pathname.includes('teaching'))
			return SIDEBAR_ITEMS_TEACHER;
		else
